...
//askv    			Assert.assertEquals(JsonArrayObject.get("applied_discounts").toString(),_CP.rs.getString("applied_discounts").toString(), "applied_discount not Match in Row" + Iteration);
