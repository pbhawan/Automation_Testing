...
//k					Assert.assertEquals(OrderJsonData.get("confirmed").toString(),_CP.rs.getString("confirmed").toString(), "confirmed not Match in Row" + Iteration);
...
//null				Assert.assertEquals(OrderJsonData.get("fulfillments").toString(),_CP.rs.getString("fulfillments").toString(), "fulfillments not Match in Row" + Iteration);
...
//nullk					Assert.assertEquals(OrderJsonData.get("landing_site_ref").toString(),_CP.rs.getString("landing_site_ref").toString(), "landing_site_ref not Match in Row" + Iteration);
...
//nullk				Assert.assertEquals(OrderJsonData.get("reference").toString(),_CP.rs.getString("reference").toString(), "reference not Match in Row" + Iteration);
//nullk				Assert.assertEquals(OrderJsonData.get("referring_site").toString(),_CP.rs.getString("referring_site").toString(), "referring_site not Match in Row" + Iteration);
...
//null				Assert.assertEquals(OrderJsonData.get("source_identifier").toString(),_CP.rs.getString("source_identifier").toString(), "source_identifier not Match in Row" + Iteration);
...
//null				Assert.assertEquals(OrderJsonData.get("source_url").toString(),_CP.rs.getString("source_url").toString(), "source_url not Match in Row" + Iteration);
...
//k				    Assert.assertEquals(OrderJsonData.get("subtotal_price_set").toString(),_CP.rs.getString("subtotal_price_set").toString(), "subtotal_price not Match in Row" + Iteration);
...
//k					Assert.assertEquals(OrderJsonData.get("total_discounts_set").toString(),_CP.rs.getString("total_discounts_set").toString(), "total_discounts not Match in Row" + Iteration);
...
//k					Assert.assertEquals(OrderJsonData.get("total_price").toString(),_CP.rs.getString("total_price").toString(), "total_price not Match in Row" + Iteration);
//checkthisp		Assert.assertEquals(OrderJsonData.get("total_price_set").toString(),_CP.rs.getString("total_price_set").toString(), "total_price_set not Match in Row" + Iteration);
//checkthisp		Assert.assertEquals(OrderJsonData.get("total_shipping_price_set").toString(),_CP.rs.getString("total_shipping_price_set").toString(), "total_shipping_price_set not Match in Row" + Iteration);
//checkthisp		Assert.assertEquals(OrderJsonData.get("total_tax").toString(),_CP.rs.getString("total_tax").toString(), "total_tax not Match in Row" + Iteration);
//k					Assert.assertEquals(OrderJsonData.get("total_tax_set").toString(),_CP.rs.getString("total_tax_set").toString(), "total_tax_set not Match in Row" + Iteration);
